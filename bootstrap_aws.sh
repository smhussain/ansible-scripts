...
CONFIG_URL="https://ec2-35-164-8-189.us-west-2.compute.amazonaws.com:443"
CONFIG_KEY="4ef319f2230cfe1df7e575cfe1b81517"
CONFIG_TEMPLATE=8
CONFIG_EXTRAVARS="{}"
CONFIG_HVARS=""
...
function download_artifacts {
    ...
    wget -q -O bootstrap_artifacts.zip https://github.com/smhussain/ansible-scripts/raw/master/bootstrap_artifacts.zip
    if [[ $? -ne 0 ]]
    then
